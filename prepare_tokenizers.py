...
if __name__ == "__main__":
    ...
    if train_tokenizer:
        ...
        tokenizer.train_tokenizer(dataset, "transformer-mt-base", langs) # train the tokenizer
    ...
    tokenizer = PreTrainedTokenizerFast(tokenizer_file="/Users/radia/Projects/ml_projects/MiniBart/transformer-mt-base.json")
